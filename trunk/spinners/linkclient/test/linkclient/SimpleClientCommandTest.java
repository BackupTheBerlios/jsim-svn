 ...
 * @author Roger
 */
public class SimpleClientCommandTest extends TestCase {
     ClientFrame cf;
     List liste;
     
    public SimpleClientCommandTest(String testName) {
        super(testName);
...
//        cf.close();
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(SimpleClientCommandTest.class);
...
//        Object reply = instance.getReply();
//        Command command = (Command)reply;
//        System.out.println("SimpleClientCommandTest: testGetReply - string: "+ result.toString());
//        Command command = (Command)result;
//        assertEquals(expResult, result);
//        System.out.println("SimpleClientCommandTest: testGetReply: "+
//                                command.getName()+command.getId());
