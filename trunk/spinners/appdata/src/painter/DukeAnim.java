 ...
 * DukeAnim.java
 *
 * Created on 02 April 2007, 23:16
 */
...
public class DukeAnim extends JApplet implements ImageObserver {
    ...
    public void init() {
        ...
        try {
            String imageFileName = "C:/Documents and Settings/" +
               "All Users/Documents/My Pictures/Sample Pictures/Blue hills.jpg";
            clouds = ImageIO.read(new File(imageFileName));
            System.out.println("Image is "+imageFileName+" "+clouds);                        
        } catch (IOException e) {
            System.out.println("EXCEPTION: Did not read file ");            
        }      
        try {
            String imageFileName = "C:/Program Files/Java/jdk1.6.0_01/" +
               "demo/plugin/jfc/Java2D/src/images/duke.running.gif";            
            agif = ImageIO.read(new File(imageFileName));
            System.out.println("Image is "+imageFileName+" "+agif);                        
        } catch (IOException e) {
            System.out.println("EXCEPTION: Did not read file ");            
        }      
