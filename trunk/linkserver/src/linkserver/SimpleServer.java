...
{
  private List liste;
  private InterServer refInterServer;
   ...
   */
  public SimpleServer(List liste, InterServer interServer)
  {
    super(12345);
    this.liste = liste;
    refInterServer = interServer;
  }
   ...
   * @param liste the liste on which information will be displayed.
   */
  public SimpleServer(int port, List liste, InterServer interServer)
  {
    super(port);
    this.liste = liste;
    refInterServer = interServer;
