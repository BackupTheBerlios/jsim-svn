...
//    MainForm mainForm;
     ...
     */
    public AppModel(AppServer appServer, String title, String[] args){
...
//        mainForm = new MainForm(this, title, sysMode, clientCount);
        ...
        // The Client window control frame:
        if (args.length==1)//**
         sf = new ClientFrame("localhost",12345,this,title,
                                        sysMode,clientCount);
        if (args.length==2)
         sf = new ClientFrame("localhost",Integer.parseInt(args[1]),this,title,
                                        sysMode,clientCount);
        if (args.length==3)
         sf = new ClientFrame(args[1],Integer.parseInt(args[2]),this,title,
                                        sysMode,clientCount);
//        mainForm.setVisible(true);
     ...
     * 
     * @param sf provides reference through to the Buttons
     */
